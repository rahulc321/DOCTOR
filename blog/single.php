...
<h2><span class="redb">Blog</span> Details</h2>
...
<div class="row">
  <?php 
            $sql = "SELECT * FROM blog where `title`='".str_replace('-',' ',$_GET['title'])."'";
...
<div class="col-sm-12">
  <a href="single.php?<?=str_replace(' ','-',$row['title'])?>"><img src="<?=SITEURL.$row['image']?>" style="width: 100%;
    border-radius: 2px;    height: auto;box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;"></a>
