...
<h2><span class="redb">About</span> Us</h2>
...
<div class="col-sm-3">
  <a href="single.php?title=<?=str_replace(' ','-',$row['title'])?>"><img src="<?=SITEURL.$row['image']?>" style="width: 279px;
    border-radius: 2px;    height: 230px;box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;"></a>
