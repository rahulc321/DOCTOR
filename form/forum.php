...
<h2><span class="redb">Forum</span> Details</h2>
...
<div class="row">
  <?php 
            $sql = "SELECT * FROM form where `title`='".str_replace('-',' ',$_GET['title'])."'";
            $result = $conn->query($sql);

            
             $row = $result->fetch_assoc()?>

<div class="col-sm-12"  style="box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;padding: 20px">
